...
Movie.prototype.changeRating = function (number) {return this.rating = ((this.rating + number)/2)}
...
User.prototype.removeSavedPost = function(searchedId) {
  
  let index = this.savedPosts.findIndex((element) => {
    return +element.id === +searchedId
  })
...
User.prototype.changePostRating = function(searchedId, newRating) {
  let index = this.savedPosts.findIndex((element) => {
    return +element.id === +searchedId
  })
